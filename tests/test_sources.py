...
def test_detail(client):
    ...
    assert source.description_html == "<p>Upload: nzdf-built-up-area-area-feature-SHP.zip</p>"
...
def test_datasource_detail(client):
    responses.add(responses.GET,
        client.get_url('DATASOURCE', 'GET', 'single', {'source_id': 21838, 'datasource_id': 144187}),
...
def test_datasource_metadata(client):
    responses.add(responses.GET,
        client.get_url('DATASOURCE', 'GET', 'single', {'source_id': 55, 'datasource_id': 167}),
        body=datasource_detail_2, status=200,
        content_type='application/json')
    responses.add(responses.GET,
        client.get_url('DATASOURCE', 'GET', 'single', {'source_id': 55, 'datasource_id': 167}) + 'metadata/',
