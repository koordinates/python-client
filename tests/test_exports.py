...
def test_export_list(client):
    ...
    for e in client.exports.list():
        ...
        if e == 0:
            ...
            assert e.download_url == "https://test.koordinates.com/services/api/v1/exports/19/download/"
...
def test_cropfeature_detail(client):
    responses.add(responses.GET,
      client.get_url('CROPFEATURE', 'GET', 'single', {'croplayer_id': 2, 'cropfeature_id': 442}),
